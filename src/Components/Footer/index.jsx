                    ...
                    <Grid container spacing={2} sx={{  height:"100%"}}>
                        ...
                        textAlign:{xs:"center",sm:"left"},margin:{xs:"50px 0px"}}}>
                            <LogoSize>
                                ...
                                <Box sx={{ color: "#ebebeb"}}>
                                    <Typography>Gouri Bhawan, Gopinathpur Sagarbhanga, Durgapur-19 </Typography>
                                    <Typography>Sanjib Sarani,Beside Maharaja Weighbridge,Durgapur-01  </Typography>
                                    <Typography>9679117507, 9333795331 </Typography>
                                    <Typography>9800004250</Typography>
                                    <Typography>techmeeco.infrapl@gmail.com</Typography>
                                </Box>
                            </LogoSize>
                        </Grid>
                        ...
                        textAlign:{xs:"center",sm:"left"},padding:{ xs:"50px 0px"},margin:{xs:"50px 0px"}}}>
                            <Box sx={{ position: "absolute", zIndex: "2", textAlign: { xs: "center", md: "left" }, marginTop: { xs: "70px", md: "0px" }, paddingLeft:{ xs:"0px",sm:"30px"} }}>
                                ...
                                <StyledUl>
                                    ...
                                    <StyledItem>
                                        <StyledLinks to="/cer">Certification</StyledLinks>
                                    </StyledItem>
                                    <StyledItem>
                                        <StyledLinks to="/contact">Contact</StyledLinks>
                                    </StyledItem>
                                    <StyledItem>
                                        <StyledLinks to="/">Blog</StyledLinks>
                                    </StyledItem>
                                </StyledUl>
                            </Box>
                        </Grid>
                        ...
                        ,margin:{xs:"20px 0px 0px 0px",sm:"50px 0px"}}}>
                            <Box sx={{ position: "absolute", zIndex: "2"}}>
                                ...
                                TechMeeco<Typography sx={{ color: "white"}}>Copyright © 2024 | TechMeeco</Typography>
                            </Box>
                        </Grid>
                    </Grid>
                </Container>
